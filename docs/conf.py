...
html_theme_options = {
    ...
    'extra_nav_links': {
        'invenio-oauth2server@GitHub': 'http://github.com/inveniosoftware/invenio-oauth2server',
        'invenio-oauth2server@PyPI': 'http://pypi.python.org/pypi/invenio-oauth2server/',
    }
}
